# Chapter 1 — The Sixteen Revelations

> **Apparatus layer.** This first chapter is a scribal table of the sixteen
> revelations, not Julian's running prose (see `NOTES.md`). It is rendered faithfully
> here, but is to be set apart typographically in the final edition — candidate
> treatment: an illuminated opening list. The Sloane incipit that precedes it
> (*"Revelations to one who could not read a letter…"*) is held for the front matter,
> not reproduced here.
...
This is a showing of love that Jesus Christ, our endless bliss, made in sixteen showings, or particular revelations.
...
The fourth is the scourging of his tender body, with the plenteous shedding of his blood.
